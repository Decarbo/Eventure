						...
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3   mt-10 gap-6 ">
							{Event.map((item) => {
								return (
									<div
										key={item.id}
										className="min-h-[461px] max-w-[512px] rounded-[10px]">
										<div className="">
											<img
												src={item.image}
												alt=""
												className="w-[]  object-cover rounded-t-[10px] "
											/>
										</div>

										<div className="flex gap-4">
											<div className="flex justify-between  gap-2 mt-4 w-[30%]">
								...
								return (
									<div
										...
										<div className="flex gap-4">
												...
												<div className="flex justify-between r gap-2 mt-4 w-[30%]">
													<div className="flex flex-col text-center">
														<p className="text-[#4539B4] font-bold text-3xl">{item.month}</p>
														<p className="text-[#2D2C3C] font-bold text-3xl">{item.day}</p>
													</div>
